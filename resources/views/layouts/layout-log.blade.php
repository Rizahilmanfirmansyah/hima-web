        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="{{route('product_masuk.activity')}}"><i class="menu-icon fa fa-arrow-circle-right"></i>Aktivitas Produk Masuk</a>
                    </li> 
                    <li class="">
                        <a href="{{route('product_keluar.activity')}}"><i class="menu-icon fa fa-arrow-circle-left"></i>Aktivitas Produk Keluar</a>
                    </li>    
